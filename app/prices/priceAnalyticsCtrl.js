(function () {
        ...
        function PriceAnalyticsCtrl($scope, $filter, products, productServices) {
            $scope.title = "Price Analytics";

            // Computed
            for (var i = 0; i < products.length; i++) {
                products[i].marginPercent =
                    productServices.calculateMarginPercent(products[i].price, products[i].cost);
                products[i].marginAmount =
                    productServices.calculateMarginAmount(products[i].price, products[i].cost);
            }
